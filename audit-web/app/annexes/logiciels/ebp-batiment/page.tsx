    ...
    <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-teal-100 text-xl mb-6">
              Solution ERP spÈcialisÈe pour les entreprises du BTP et de l'ÈlectricitÈ
            </p>
            <div className="flex flex-wrap gap-3">
              <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-lg">
                <span className="text-sm font-semibold"><Î<˜ EBP (France)</span>
              </div>
              <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-lg">
                <span className="text-sm font-semibold">SpÈcialisÈ BTP</span>
              </div>
              <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-lg">
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-12">
        <div className="bg-orange-50 border-2 border-orange-200 rounded-xl p-6">
          ...
          <p className="text-sm text-orange-700 font-semibold mb-1">Prix estimÈ</p>
        ...
        <div className="bg-teal-50 border-2 border-teal-200 rounded-xl p-6">
          ...
          <p className="text-sm text-teal-700 font-semibold mb-1">SpÈcialisation</p>
          <p className="text-3xl font-bold text-teal-900">Expert</p>
          <p className="text-xs text-teal-600">BTP & …lectricitÈ</p>
        </div>
        <div className="bg-red-50 border-2 border-red-200 rounded-xl p-6">
          <TrendingUp className="w-8 h-8 text-red-600 mb-3" />
          <p className="text-sm text-red-700 font-semibold mb-1">Co˚t 3 ans</p>
          <p className="text-3xl font-bold text-red-900">295k¨</p>
          <p className="text-xs text-red-600">avec complÈments</p>
        </div>
      </div>

      {/* FonctionnalitÈs */}
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 mb-12">
        <h2 className="text-3xl font-bold text-slate-900 mb-6">FonctionnalitÈs ClÈs BTP</h2>
          ...
          <div className="bg-teal-50 rounded-lg p-6 border border-teal-200">
            ...
            <ul className="space-y-2 text-slate-700 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Devis & MÈtrÈs intÈgrÈs</strong> : Chiffrages prÈcis avec tranches de travaux</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-1" />
                <span><strong>Attestations TVA taux rÈduit</strong> : GÈnÈration automatique</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-1" />
                <span><strong>Interface Tarifeo</strong> : AccËs +700 fournisseurs BTP, tarifs ‡ jour</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-1" />
                <span><strong>IntÈgration Sonepar native</strong> : Import offres de prix automatique</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-1" />
                <span><strong>Gestion primes CEE, MaPrimeRenov'</strong> : Primes dÈductibles</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-1" />
                <span><strong>Support franÁais</strong> : Assistance tÈlÈphone direct</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-red-50 rounded-lg p-6 border border-red-200">
            ...
            <ul className="space-y-2 text-slate-700 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Pas de CRM</strong> : Besoin HubSpot ou autre en complÈment</span>
              </li>
              <li className="flex items-start gap-2">
                <XCircle className="w-4 h-4 text-red-600 mt-1" />
                <span><strong>Field Service basique</strong> : App mobile limitÈe, pas CERFA avancÈ</span>
              </li>
              <li className="flex items-start gap-2">
                <XCircle className="w-4 h-4 text-red-600 mt-1" />
              ...
              <li className="flex items-start gap-2">
                <XCircle className="w-4 h-4 text-red-600 mt-1" />
                <span><strong>Pas de SIRH</strong> : Besoin Lucca ou PayFit en complÈment</span>
              </li>
              <li className="flex items-start gap-2">
                <XCircle className="w-4 h-4 text-red-600 mt-1" />
                <span><strong>ScalabilitÈ limitÈe</strong> : Max 20 users version PRO</span>
              </li>
              <li className="flex items-start gap-2">
                <XCircle className="w-4 h-4 text-red-600 mt-1" />
                <span><strong>Impasse Data/IA</strong> : Base propriÈtaire fermÈe (Score 1,2/10)</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      {/* ProblËmes rÈsolus vs non rÈsolus */}
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 mb-12">
        <h2 className="text-3xl font-bold text-slate-900 mb-6">Couverture Besoins Duret</h2>

        <div className="mb-8">
          <h3 className="text-xl font-bold text-green-900 mb-4"> ProblËmes RÈsolus (Direction Affaires)</h3>
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              ...
              <p className="text-xs text-green-700"> Tableaux de bord co˚ts rÈels vs prÈvus</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              <p className="text-sm font-semibold text-slate-900 mb-1">L AccËs distance lent</p>
        ...
        <div>
          <h3 className="text-xl font-bold text-red-900 mb-4">L ProblËmes NON RÈsolus (Besoins ComplÈmentaires)</h3>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-red-50 p-4 rounded-lg border border-red-200">
              <p className="text-sm font-semibold text-slate-900 mb-1">L SystËme post-it service client</p>
              <p className="text-xs text-red-700">† EBP n'est PAS un CRM í Besoin HubSpot</p>
            </div>
            <div className="bg-red-50 p-4 rounded-lg border border-red-200">
              <p className="text-sm font-semibold text-slate-900 mb-1">L CERFA papier maintenance</p>
              <p className="text-xs text-red-700">† App mobile limitÈe, pas workflow CERFA complet</p>
            </div>
            <div className="bg-red-50 p-4 rounded-lg border border-red-200">
              <p className="text-sm font-semibold text-slate-900 mb-1">L Gestion RH/Paie</p>
              <p className="text-xs text-red-700">† Pas de SIRH í Besoin Lucca + Silae</p>
            </div>
            <div className="bg-red-50 p-4 rounded-lg border border-red-200">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border-2 border-blue-300 mb-12">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-slate-300">
                <th className="text-left py-2 px-3 text-sm">CritËre</th>
            ...
            <tbody className="text-sm">
              ...
              <tr className="border-b bg-slate-50">
                <td className="py-2 px-3">SpÈcialisation BTP</td>
                <td className="py-2 px-3 text-center text-green-600 font-bold">Expert</td>
                <td className="py-2 px-3 text-center">GÈnÈraliste</td>
              </tr>
              <tr className="border-b">
                <td className="py-2 px-3">CRM intÈgrÈ</td>
                <td className="py-2 px-3 text-center">L</td>
                <td className="py-2 px-3 text-center text-green-600"></td>
              </tr>
              <tr className="border-b bg-slate-50">
                <td className="py-2 px-3">SIRH intÈgrÈ</td>
                <td className="py-2 px-3 text-center">L</td>
                <td className="py-2 px-3 text-center text-green-600"></td>
              </tr>
              <tr className="border-b">
                ...
                <td className="py-2 px-3 text-center text-green-600 font-bold">ComplËte</td>
              </tr>
              <tr className="border-b bg-slate-50">
        ...
        <div className="bg-blue-600 text-white rounded-lg p-6">
          ...
          <p className="text-blue-100">
            <strong>Odoo maintient sa position de solution prÈfÈrentielle</strong> gr‚ce ‡ sa couverture 100%,
            son prix compÈtitif (-35% vs EBP+complÈments), et sa prÈparation Data/IA. EBP excelle en spÈcialisation
            BTP mais nÈcessite 4-5 solutions complÈmentaires pour couvrir tous les besoins Duret.
          </p>
        </div>
      </div>
      ...
      {/* Tarifs estimÈs */}
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 mb-12">
        <h2 className="text-3xl font-bold text-slate-900 mb-4">Tarifs 2025 (EstimÈs)</h2>
        <p className="text-slate-600 mb-6">† EBP ne communique pas publiquement ses tarifs. Estimations marchÈ :</p>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="border-2 border-slate-300 rounded-xl p-6">
            ...
            <p className="text-xs text-slate-600 mb-4">/user/mois estimÈ</p>
          ...
          <div className="border-2 border-teal-500 rounded-xl p-6 bg-teal-50">
            ...
            <p className="text-xs text-teal-600 mb-4">/user/mois estimÈ</p>
            <p className="text-sm text-teal-700">RecommandÈ PME BTP</p>
          </div>
          <div className="border-2 border-purple-300 rounded-xl p-6">
            ...
            <p className="text-xs text-purple-600 mb-4">/user/mois estimÈ</p>
            <p className="text-sm text-purple-700">Fonctions avancÈes</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl p-8 text-white mb-8">
        <h2 className="text-3xl font-bold mb-4">L Non RecommandÈ comme Solution Unique</h2>
        <p className="text-orange-100 text-lg mb-4">
          EBP B‚timent est une <strong>excellente solution spÈcialisÈe BTP</strong>, mais ne couvre que 88% des besoins Duret.
          Le co˚t combinÈ EBP + complÈments (295k¨ sur 3 ans) dÈpasse largement Odoo (190k¨) pour une couverture moindre.
        </p>
        <div className="grid md:grid-cols-3 gap-4 mt-6">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            <p className="text-orange-200 text-sm mb-1">Solutions nÈcessaires</p>
            <p className="font-bold">5 outils ‡ gÈrer</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
