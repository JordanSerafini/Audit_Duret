...
| Tâche | Avant (CSV) | Après (API) | Gain |
|-------|-------------|-------------|------|
| **Export factures Odoo** | 30 min/jour | 0 (auto) | 10h/mois |
| **Import SAGE** | 30 min/jour | 0 (auto) | 10h/mois |
| **Correction erreurs** | 2h/semaine | 0 | 8h/mois |
| **Lettrage manuel** | 4h/semaine | 1h/semaine (contrôle) | 12h/mois |
| **TOTAL** | | | **40h/mois** |

**Valorisation**: 40h x 50€/h = **2000€/mois** = **24K€/an**

**Autres gains**:
- ✅ Réduction erreurs comptables (-80%)
- ✅ Trésorerie temps réel (vs J+1)
- ✅ Rapprochement bancaire facilité

**Payback**: 22K€ / 24K€ = **11 mois**
